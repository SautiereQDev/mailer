export const mailerInfo = {
  ...
  version: '1.1.0',
  description: 'API for sending emails and API key management',

  authentication: {
    publicEndpoints: {
      description: 'API key authentication',
      methods: ['Header: x-api-key: <your-api-key>', 'Query parameter: ?apiKey=<your-api-key>'],
    },
    adminEndpoints: {
        ...
        responses: [
          {
            ...
            body: {
              ...
              apiKey: 'string - The generated API key (displayed only at creation)',
            },
          },
          {
            status: 400,
          ...
          },
          {
            ...
            body: { message: 'Access denied: administrator rights required' },
          },
          {
            status: 500,
            description: 'Server error',
